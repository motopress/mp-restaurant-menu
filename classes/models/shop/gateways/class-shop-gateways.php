	...
	public function get_payment_gateways() {
		...
		$gateways = array(
			'paypal'      => array(
				...
				'checkout_label' => $this->get( 'settings' )->get_option( 'paypal_title', __( 'PayPal', 'mp-restaurant-menu' ) ),
				'supports'       => array( 'buy_now' )
			),
			'test_manual' => array(
				'admin_label'    => __( 'Test Payment (auto-complete orders)', 'mp-restaurant-menu' ),
				'checkout_label' => $this->get( 'settings' )->get_option( 'test_manual', __( 'Test Payment', 'mp-restaurant-menu' ) )
			),
			'manual'      => array(

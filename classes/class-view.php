...
class View {
	...
	public function template_loader( $template ) {
		...
		if ( is_single() && in_array( $post->post_type, Core::get_instance()->get_post_types() ) ) {
		...
		} elseif ( is_restaurant_taxonomy( $taxonomy ) ) {
			...
			if ( ! empty( $theme_template ) && ( $display_taxonomy !== 'default' ) ) {
				...
				if ( is_tax( Core::get_instance()->get_tax_name( 'menu_category' ) ) || is_tax( Core::get_instance()->get_tax_name( 'menu_tag' ) ) || is_tax( Core::get_instance()->get_tax_name( 'ingredient' ) ) ) {

					...
					'main'             => array(
						...
						'template_mode'         => array(
							...
							'options'  => apply_filters( 'mprm_available_theme_mode',
								array(
									'theme'  => __( 'Theme Mode', 'mp-restaurant-menu' ),
				...
				array(
					...
					'paypal'           => array(
						...
						'paypal_description'          => array(
							...
							'desc' => __( 'This controls the description which the user sees during checkout.', 'mp-restaurant-menu' ),
							'type' => 'textarea',
							'size' => 'regular',
						),
	...
	public function get_registered_settings_sections() {
		...
		$sections = array(
			...
			'gateways'   => apply_filters( 'mprm_settings_sections_gateways', array(
				...
				'cash_on_delivery' => __( 'Cash on Delivery', 'mp-restaurant-menu' ),
			) ),

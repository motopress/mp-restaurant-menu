...
return $language = array(
	...
	//'mprm_version' => EDD_VERSION,
	'add_new_download' => __('Add New Download', 'mp-restaurant-menu'),
	...
	'copy_download_link_text' => __('Copy these links to your clipboard and give them to your customer', 'mp-restaurant-menu'),
	//'delete_payment_download' => sprintf(__('Are you sure you wish to delete this %s?', 'mp-restaurant-menu'), mprm_get_label_singular()),
	...
	'one_download_min' => __('Payments must contain at least one item', 'mp-restaurant-menu'),

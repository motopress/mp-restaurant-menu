...
return apply_filters('mprm_admin_vars', array(
		...
		'delete_payment_menu_item' => __('Are you sure you wish to delete this item?', 'mp-restaurant-menu'),
		...
		'one_option' => __('Choose an item', 'mp-restaurant-menu'),
		'one_or_more_option' => __('Choose one or more items', 'mp-restaurant-menu'),
		...
		'type_to_search' => __('Type to search', 'mp-restaurant-menu'),

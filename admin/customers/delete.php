		...
		<form id="delete-customer" method="post" action="<?php echo admin_url( 'edit.php?post_type=mp_menu_item&page=mprm-customers&view=delete&id=' . $customer->id ); ?>">
			...
			<div class="customer-info delete-customer">
				<span class="delete-customer-options">
					...
					<p>
						<?php View::get_instance()->render_html( '../admin/settings/checkbox', array( 'name' => 'mprm-customer-delete-records', 'options' => array( 'disabled' => true ) ) ); ?> <label for="mprm-customer-delete-records"><?php _e( 'Delete all associated payments and records?', 'mp-restaurant-menu' ); ?></label>
					</p>

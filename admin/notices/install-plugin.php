		...
		<a href="<?php
			echo esc_url(
				add_query_arg(
					array(
						'controller' => 'settings',
						'mprm_action' => 'create_pages',
						'_wpnonce' => wp_create_nonce( 'mprm-create-pages' )
					),
					admin_url('admin.php')
				)
			); ?>" class="button-primary"><?php esc_html_e('Activate eCommerce', 'mp-restaurant-menu'); ?></a>
		<a class="skip button" href="<?php
			echo esc_url(
				add_query_arg(
					array(
						'controller' => 'settings',
						'mprm_action' => 'skip_create_pages',
						'_wpnonce' => wp_create_nonce( 'mprm-skip-create-pages' )
					),
				admin_url('admin.php')
			)
		); ?>"><?php esc_html_e('Skip', 'mp-restaurant-menu'); ?></a>
	</p>
</div>

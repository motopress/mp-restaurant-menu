	...
	<div class="mprm-columns mprm-four">
		<?php if ( ! empty( $customer->id ) ) : ?>
			...
			<a href="<?php echo $customer_url; ?>"
			   title="<?php _e( 'View Customer Details', 'mp-restaurant-menu' ); ?>"><?php _e( 'View Customer Details', 'mp-restaurant-menu' ); ?></a>
			&nbsp;|&nbsp;
		<?php endif; ?>
		<a href="#new" class="mprm-payment-new-customer"
...
<div class="column-container new-customer mprm-row" style="display: none">
	...
	<div class="mprm-columns mprm-three">
		...
		<a href="#cancel"
		   class="mprm-payment-new-customer-cancel mprm-delete"><?php _e( 'Cancel', 'mp-restaurant-menu' ); ?></a>
	</div>

<p>
	<label for="<?php echo esc_attr( $widget_object->get_field_id('title') );?>"><?php _e('Title', 'mp-restaurant-menu'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $widget_object->get_field_id('view') );?>"><?php _e('View mode', 'mp-restaurant-menu'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $widget_object->get_field_id('categ[]') );?>"><?php _e('Categories', 'mp-restaurant-menu'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $widget_object->get_field_id('tags_list[]') );?>"><?php _e('Tags', 'mp-restaurant-menu'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $widget_object->get_field_id('item_ids') );?>"><?php _e('Menu item IDs', 'mp-restaurant-menu'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $widget_object->get_field_id('col') ); ?>"><?php _e('Columns', 'mp-restaurant-menu'); ?></label>
...
<p class="mprm-widget-price_pos <?php echo ($view === 'simple-list') ? '' : 'hidden' ?>">
	<label for="<?php echo esc_attr( $widget_object->get_field_id('price_pos') );?>"><?php _e('Price position', 'mp-restaurant-menu'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $widget_object->get_field_id('categ_name') );?>"><?php _e('Show category name', 'mp-restaurant-menu'); ?></label>
...
<p>
	...
	<label for="<?php echo esc_attr( $widget_object->get_field_id('show_attributes') );?>"><?php _e('Show attributes', 'mp-restaurant-menu'); ?></label>
</p>
<p class="mprm-widget-feat_img <?php echo ($view !== 'simple-list') ? '' : 'hidden' ?>">
	...
	<label for="<?php echo esc_attr( esc_attr( $widget_object->get_field_id('feat_img') ) );?>"><?php _e('Show featured image', 'mp-restaurant-menu'); ?></label>
</p>
<p>
	...
	<label for="<?php echo esc_attr( $widget_object->get_field_id('excerpt') );?>"><?php _e('Show excerpt', 'mp-restaurant-menu'); ?></label>
</p>
...
<p>
	...
	<label for="<?php echo esc_attr( $widget_object->get_field_id('price') );?>"><?php _e('Show price', 'mp-restaurant-menu'); ?></label>
</p>
<p>
	...
	<label for="<?php echo esc_attr( $widget_object->get_field_id('tags') );?>"><?php _e('Show tags', 'mp-restaurant-menu'); ?></label>
</p>
<p>
...
<p class="mprm-widget-buy <?php echo ($view !== 'simple-list') ? '' : 'hidden' ?>">
	...
	<label for="<?php echo esc_attr( $widget_object->get_field_id('buy') );?>"><?php _e('Show buy button', 'mp-restaurant-menu'); ?></label>
</p>
...
<p>
	...
	<label for="<?php echo esc_attr( $widget_object->get_field_id('link_item') );?>"><?php _e('Link item', 'mp-restaurant-menu'); ?></label>
</p>
<p>
	<label for="<?php echo esc_attr( $widget_object->get_field_id('desc_length') );?>"><?php _e('Excerpt length', 'mp-restaurant-menu'); ?></label>

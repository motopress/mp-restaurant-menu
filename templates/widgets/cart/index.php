		...
		<ul class="mprm-cart">
			<?php if ($cart_items) : ?>
				...
				<?php if (mprm_use_taxes()) : ?>
					<li class="cart_item mprm-cart-meta mprm_subtotal"><?php echo __('Subtotal:', 'mp-restaurant-menu') ?> <span class='subtotal'><?php echo mprm_currency_filter(mprm_format_amount(mprm_get_cart_subtotal())); ?></span></li>
				...
				<li class="cart_item mprm-cart-meta mprm_total"><?php _e('Total:', 'mp-restaurant-menu'); ?> <span class="cart-total"><?php echo mprm_currency_filter(mprm_format_amount($cart_total)); ?></span></li>
			...
			<?php else : ?>
				...
				<?php if (mprm_use_taxes()) : ?>
					<li class="cart_item mprm-cart-meta mprm_subtotal" style="display:none;"><?php echo __('Subtotal:', 'mp-restaurant-menu'); ?> <span class='subtotal'><?php echo mprm_currency_filter(mprm_format_amount(mprm_get_cart_subtotal())); ?></span></li>
				...
				<li class="cart_item mprm-cart-meta mprm_total" style="display:none;"><?php _e('Total:', 'mp-restaurant-menu'); ?>
					<span class="cart-total"><?php echo mprm_currency_filter(mprm_format_amount($cart_total)); ?></span>
				</li>

	...
	<div class="mprm-cart-content">
		...
		<ul class="mprm-cart">
			...
			<?php else : ?>
				...
				<?php if (mprm_use_taxes()) : ?>
					<li class="cart_item mprm-cart-meta mprm_subtotal" style="display:none;"><?php echo __('Subtotal:', 'mp-restaurant-menu'); ?> <span class='mprm_cart_subtotal_amount subtotal'><?php echo mprm_currency_filter(mprm_format_amount(mprm_get_cart_subtotal())); ?></span></li>

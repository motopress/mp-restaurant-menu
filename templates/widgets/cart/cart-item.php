<li class="mprm-cart-item">
	...
	<a href="{remove_url}" data-cart-item="{cart_item_id}" data-download-id="{item_id}" data-action="mprm_remove_from_cart" class="mprm-remove-from-cart"><?php _e('remove', 'mp-restaurant-menu'); ?></a>
</li>

...
<li class="mprm-cart-item">
	...
	<span class="mprm-cart-item-separator">-</span><span class="mprm-cart-item-quantity">&nbsp;{item_quantity}&nbsp;:&nbsp;</span><span class="mprm-cart-item-price">&nbsp;{item_amount}&nbsp;</span>
	<a href="{remove_url}" data-cart-item="{cart_item_id}" data-menu-item-id="{item_id}" data-action="mprm_remove_from_cart" class="mprm-remove-from-cart"></a>
